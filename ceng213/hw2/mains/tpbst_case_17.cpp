...
/*
 * Case 17 : Empty tree, insert many items, create primary node with empty secondary tree, find, print.
 */
int main() {
    ...
    int *temp = NULL;
    if ((temp = tpbst.find("ceng435", "sec4")) != NULL)
        std::cout << *temp << std::endl;
    if ((temp = tpbst.find("ceng351", "sec2")) != NULL)
        std::cout << *temp << std::endl;
    if ((temp = tpbst.find("ceng453", "sec1")) != NULL)
        std::cout << *temp << std::endl;
    if ((temp = tpbst.find("ceng477", "sec2")) != NULL)
        std::cout << *temp << std::endl;
