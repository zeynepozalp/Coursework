...
private:
    ...
    Node<User>* findUserNode(LinkedList<User> users, const string & userName);
    User* findUser(LinkedList<User> users, const string & userName);
    Video* findVideo(LinkedList<Video> videos, const string & videoName);
    void bubbleSort(LinkedList<Video*> subs);
